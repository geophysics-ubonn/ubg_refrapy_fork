        ...
        if self.projReady:
            ...
            if self.data_pg == False:    
                ...
                if pickFile:
                    ...
                    print(self.data_pg)
                    # Remove picks at source positions
                    self.data_pg.markInvalid(pg.abs(self.data_pg('s') - self.data_pg('g')) == 0)
                    self.data_pg.markInvalid(self.data_pg('t') <= 0.)
                    self.data_pg.removeInvalid()
                    ...
                    with open(pickFile, "r") as file:
                        ...
                        if 'err' in words:
                            ...
                            err = [0.0 for _ in range(len(t))]                      
                        sx = [sgx[i-1] for i in s]
                        gx = [sgx[i-1] for i in g]
                        sz = [sgz[i-1] for i in s]
                        ...
                        for i,src in enumerate(list(set(sx))):
                            ...
                            for j,x in enumerate(gx):
                                ...
                                if sx[j] == src:
                                    ...
                                    self.errdata[i][src].append(err[j])
