...
class Refrapick(Tk):
    ...
    def __init__(self):
        ...
        self.ico_newProject = PhotoImage(
           file=self._get_image('ico_newProject.gif')
        )
        self.ico_loadProject = PhotoImage(
            file=self._get_image('ico_loadProject.gif')
        )
        self.ico_resample = PhotoImage(
            file=self._get_image('ico_resample.gif')
        )
        self.ico_survey = PhotoImage(file=self._get_image('ico_survey.gif'))
        self.ico_shotTime = PhotoImage(
            file=self._get_image('ico_shotTime.gif')
        )
        self.ico_loadPicks = PhotoImage(
            file=self._get_image('ico_loadPicks.gif')
        )
        self.ico_allPicks = PhotoImage(
            file=self._get_image('ico_allPicks.gif')
        )
        self.ico_restoreTraces = PhotoImage(
            file=self._get_image('ico_restoreTraces.gif')
        )
        self.ico_help = PhotoImage(file=self._get_image('ico_help.gif'))
        self.ico_plotOptions = PhotoImage(
            file=self._get_image('ico_plotOptions.gif')
        )
        self.ico_errorOptions = PhotoImage(
            file=self._get_image('ico_error.png')
        )
